...
class ToothacheAndGingivitisScreen extends StatefulWidget {

  const ToothacheAndGingivitisScreen({super.key});

  @override
  State<ToothacheAndGingivitisScreen> createState() => _ToothacheAndGingivitisScreenState();
}

class _ToothacheAndGingivitisScreenState extends State<ToothacheAndGingivitisScreen> {
  String herbal1 ='';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          Text(
            arabic == false ? 'Toothache and Gingivitis' : 'وجع الاسنان والتهاب اللثة',
        ...
        body: FutureBuilder(
          future:physio.doc('TOOTHACHEANDGINGIVITIS').get(),
