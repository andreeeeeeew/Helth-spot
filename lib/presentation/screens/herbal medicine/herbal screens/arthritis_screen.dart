...
class ArthritisScreen extends StatefulWidget {

  const ArthritisScreen({super.key});

  @override
  State<ArthritisScreen> createState() => _ArthritisScreenState();
}

class _ArthritisScreenState extends State<ArthritisScreen> {
  String herbal1 = '';
  ...
  FirebaseFirestore.instance.collection('HerbalMedicine');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          Text(
            arabic == false ? 'Arthritis' : 'التهاب المفاصل',
        ...
        body: FutureBuilder(
          future: physio.doc('Arthritis').get(),
