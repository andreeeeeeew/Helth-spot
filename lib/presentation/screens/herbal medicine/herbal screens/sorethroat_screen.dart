...
class SoreThroatScreen extends StatefulWidget {

  const SoreThroatScreen({super.key});

  @override
  State<SoreThroatScreen> createState() => _SoreThroatScreenState();
}

class _SoreThroatScreenState extends State<SoreThroatScreen> {
  String herbal1 ='';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title:
          Text(
            arabic == false ? 'Sore Throat' : 'إلتهاب الحلق',
        ...
        body: FutureBuilder(
          future:physio.doc('SORETHROAT').get(),
